  ...
  const handleRecovery = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: error.message || "Ocorreu um erro ao tentar enviar o e-mail de recuperação",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
            ...
            <form onSubmit={handleRecovery} className="space-y-6">
              ...
              <div className="space-y-4">
                <Button
                  ...
                  disabled={isLoading}
                >
                  {isLoading ? "Enviando..." : t.sendInstructions}
                </Button>
                <Button
                  type="button"
                  variant="ghost"
        ...
        <div className="w-full md:w-2/5 p-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              ...
              disabled={isLoading}
            >
              {isLoading ? "Carregando..." : mode === 'login' ? t.login : t.signup}
            </Button>
